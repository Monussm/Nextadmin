    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li className="nav-item dropdown mx-3">
        ...
        <li className="nav-item dropdown">
          ...
          <ul className="dropdown-menu">
            <li><NavLink to="/testimonial" className="dropdown-item" ><i className="fa-solid fa-star me-2"></i>Testimonials</NavLink></li>
        ...
        <li className="nav-item dropdown">
          ...
          <ul className="dropdown-menu">
            <li><NavLink to="/Timer" className="dropdown-item" ><i className="fa-solid fa-magnifying-glass me-2"></i>Essay Scanner</NavLink></li>
